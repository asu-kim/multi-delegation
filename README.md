...
- **experiments**: Contains runnable experiment code and collected logs for demonstrating the user/agent workflow.
...
Detailed instructions of the experiment process can be found in [experiments/README.md](experiments/README.md).
