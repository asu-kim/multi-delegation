...
- **t = 6-9 (Revocation)**: Represents the revocation phase, where previously delegated access rights (`N_0` revokes `N_1`'s access, `N_2` after expiration time) are removed.
